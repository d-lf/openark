...
sequenceDiagram
    ...
    Note over Steve,Victoria: Multicast messages are logically sent once by Steve
and delivered to all round participants
    ...
    par Multicast: new_round_initiate
        ...
        Steve->>Victoria: new_round_initiate
    end
    ...
    par Multicast: new_round_vtxo_tree_proposal
        ...
        Steve->>Dave: new_round_vtxo_tree_proposal
        Steve->>Eve: new_round_vtxo_tree_proposal
        Steve->>Victoria: new_round_vtxo_tree_proposal
    end
    ...
    Note over Steve,Victoria: Steve broadcasts vtxo-root on-chain
    ...
    par Multicast: new_round_start
        ...
        Steve->>Victoria: new_round_start
    end
```
